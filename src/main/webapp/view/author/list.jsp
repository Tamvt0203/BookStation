	...
	<div class="admin_container container">
		...
		<button class="btn btn-primary mb-2">
			<a class="admin_button"
				href="${pageContext.request.contextPath}/AuthorController?action=get-form-insert">Create
				New</a>
		</button>
		...
		<table class="table">
			...
			<tbody>
				...
				<tr class="Search">
					...
					<td><a
						href="${pageContext.request.contextPath}/AuthorController?action=get-form-edit&id=<%=list.get(i).getAuthorId()%>">Edit</a>
						| <a
						href="${pageContext.request.contextPath}/AuthorController?action=handle-delete&id=<%=list.get(i).getAuthorId()%>">Delete</a>
					</td>
				</tr>
				<%
				}
...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/jquery-3.6.4.min.js"></script>
<script>
